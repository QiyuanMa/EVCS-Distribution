...
% 但是本质和性能没有区别
net=newff(pn,tn,[5 7 2],{'purelin','logsig','purelin'});
% 10轮回显示一次结果
...
% 绘值公路客运量对比图
x=1:24;
subplot(2,1,1);plot(x,newk,'r-o',x,rf,'b--+')    
legend('网络输出超级充电站数量','实际超级充电站数量');
xlabel('states');ylabel('数量/所');
title('运用工具箱客运量学习和测试对比图');
% 绘制公路货运量对比图
subplot(2,1,2);plot(x,newh,'r-o',x,rg,'b--+')     
legend('网络输出普通充电器数量','实际充电器数量');
xlabel('states');ylabel('数量/个');
